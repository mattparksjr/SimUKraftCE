...
public class SimUKraftCE {
    ...
    // Create a Deferred Register to hold Blocks which will all be registered under the "simukraftce" namespace
...
//            }).build());
    ...
    public SimUKraftCE(IEventBus modEventBus, ModContainer modContainer) {
        ...
        // Note that this is necessary if and only if we want *this* class (SimUKraftCE) to respond directly to events.
